...
namespace Clide
{
	class ProjectContainerNode : ProjectItemContainerNode<IProjectNode, Project>
	{
		readonly Lazy<IVsHierarchyItem> hierarchyNode;

		public ProjectContainerNode(IProjectNode node, Lazy<ISolutionExplorerNodeFactory> nodeFactory)
