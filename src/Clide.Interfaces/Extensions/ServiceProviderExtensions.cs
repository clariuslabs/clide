...
public static partial class ServiceProviderExtensions
{
    ...
    public static T GetService<T>(this IServiceProvider provider)
    {
        ...
        if (service == null)
            throw new MissingDependencyException(Strings.IServiceServiceExtensions.MissingDependency(typeof(T)));
    ...
    public static TService GetService<TRegistration, TService>(this IServiceProvider provider)
    {
        ...
        if (service == null)
            throw new MissingDependencyException(Strings.IServiceServiceExtensions.MissingDependency(typeof(TRegistration)));
